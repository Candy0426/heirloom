...
export default function SignupPage() {
  ...
  // Create client inside component to avoid build-time initialization issues
    ...
    <div className="min-h-screen bg-stone-950 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-stone-100">Create your vault</h1>
        </div>
