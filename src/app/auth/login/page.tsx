...
export default function LoginPage() {
  ...
  const handleMfaVerify = async (e: React.FormEvent) => {
    ...
    try {
      // Verify the MFA code with challenge
    ...
    <div className="min-h-screen bg-stone-950 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm">
        <div className="text-center mb-6 sm:mb-8">
          ...
          {mfaStep && (
            <p className="text-stone-400 text-sm mt-2">Enter the 6-digit code from your authenticator app</p>
          )}
        </div>
        ...
        {!mfaStep ? (
          ...
          <form onSubmit={handleMfaVerify} className="space-y-4">
            <input
              ...
              maxLength={6}
              required
              className="w-full px-4 py-3 rounded-lg bg-stone-900 border border-stone-800 text-stone-100 placeholder:text-stone-500 focus:outline-none focus:border-amber-500 text-base min-h-[48px] text-center text-2xl tracking-[0.5em]"
            />
            {error && <p className="text-rose-500 text-sm">{error}</p>}
            ...
            <button
              ...
              className="w-full py-2 text-sm text-stone-400 hover:text-stone-200 transition-colors"
            >
              ← Back to login
            </button>
          </form>
          ...
          <>
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-stone-950 text-stone-500">or</span>
              </div>
            </div>
